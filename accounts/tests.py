...
class ProfileImageAccountIntegrationTests(APITestCase):
    ...
    def test_create_school_autogenerates_registration_number_and_lists_created_at(self):
        ...
        # 1. Create school without registration_number
        payload = {
        ...
        # Verify it autogenerated a registration number
        ...
        # 2. Get all schools and verify created_at is present in the response
