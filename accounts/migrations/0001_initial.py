# Generated by Django 5.2.12 on 2026-04-01 11:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('SCHOOL', 'School'), ('TEACHER', 'Teacher'), ('STUDENT', 'Student')], max_length=20)),
                ...
                ('school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='school_users', to=settings.AUTH_USER_MODEL)),
